                                ...
                                <div class="card-body card-block">
                                   <form action="update.php" method="post">
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" name="idCust" class="form-control"  value="<?php echo $d['id']; ?>">
                                        
                                    </div>

                                    <div class="form-group">
                                        <label for="first_name" class=" form-control-label">First Name</label>
                                        <input type="text" name="first_name" value="<?php echo $d['first_name']; ?>" class="form-control">
                                    ...
                                    <div class="form-group">
                                        <label for="jk" class=" form-control-label">Gender</label>
                                        <input type="text" name="jk" class="form-control" value="<?php echo $d['jk']; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="password" placeholder="Enter Password.." class="form-control" value="<?php echo $d['password']; ?>"> 
